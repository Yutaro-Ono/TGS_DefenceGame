...
private:
	...
	int      m_nowButton[XINPUT_BUTTON::XINPUT_ALL];          // 現在のボタン
	int     m_prevButton[XINPUT_BUTTON::XINPUT_ALL];          // 前のフレームのボタン

	char                                 m_key[256];          // 現在のキー
	char                         m_keyState[2][256];          // キーの状態
	...
	static const int LSTICK_DEADZONE;                         // 左スティックのデッドゾーン
